...
D_a
=
\sqrt{N_{J,a}}\cos\frac{\theta_a}{2},
\qquad
E_a
=
\sqrt{N_{J,a}}e^{-i\phi_a}\sin\frac{\theta_a}{2}.
\end{equation}

More generally, the two groups may have different steady-state angles and phases.
...
|d_a|^2
=
N_{J,a}\cos^2\frac{\theta_a}{2},
\qquad
|e_a|^2
=
N_{J,a}\sin^2\frac{\theta_a}{2},
\end{equation}
we find
