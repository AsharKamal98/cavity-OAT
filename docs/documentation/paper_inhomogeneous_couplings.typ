...
Angle and Bloch-vector averages across sectors or trajectories should follow `docs/instructions/bloch_vector_averaging.tex`. In particular, do not average angles directly. Average the appropriate normalized components or moments first, then construct $theta$ and $phi$.
...
The average angle convention should follow `docs/instructions/bloch_vector_averaging.tex`.
